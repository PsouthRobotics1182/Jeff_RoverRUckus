...
public class FishyAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        final double rotationsneeded = ((914.4/circumference) / DRIVE_GEAR_REDUCTION * .745);//number of mm divided by circumference
        ...
        while(LeftF.isBusy() || LeftR.isBusy() || RightF.isBusy() || RightR.isBusy()){
            telemetry.addData("Driving", "12 in");
            telemetry.update();
        }
